      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="/" className="text-heading hover:text-primary font-medium text-sm transition-colors">Home</Link>
            <Link href="/products" className="text-heading hover:text-primary font-medium text-sm transition-colors">Products</Link>
            <Link href="/about" className="text-heading hover:text-primary font-medium text-sm transition-colors">About Us</Link>
            <Link href="/contact-us" className="text-heading hover:text-primary font-medium text-sm transition-colors">Contact</Link>
          </nav>
